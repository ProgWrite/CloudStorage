...
Многопользовательское облачное хранилище файлов, вдохновленное Google Drive. Позволяет пользователям безопасно загружать, хранить, управлять и скачивать свои файлы и папки через удобный веб-интерфейс.
## 🚀 Основной функционал
